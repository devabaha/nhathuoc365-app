...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "re-open language in Account"
code-push release-react tick-homeid-android android -d "Production" -m --description "re-open language in Account"
