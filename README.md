...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "Them thong tin notify cua hang"
code-push release-react tick-homeid-android android -d "Production" -m --description "Them thong tin notify cua hang"
