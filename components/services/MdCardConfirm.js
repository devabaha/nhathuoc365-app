            ...
            <View style={styles.block_detail_content}>
              <View>
                ...
                <View style={styles.block_continue_content_label_no_border}>
                  ...
                  <View style={styles.block_continue_content_label_right}>
                    <Text
                      style={[styles.blocl_continue_input_label, {color: DEFAULT_COLOR}]}>{this.props.detail.price_select}</Text>
                  </View>
                </View>
                <View style={styles.block_continue_content_label}>
                  ...
                  <View style={styles.block_continue_content_label_right}>
                    <Text
                      style={[styles.blocl_continue_input_label, {color: DEFAULT_COLOR}]}>{this.props.detail.discount_label}</Text>
                  </View>
                </View>
                <View style={styles.block_continue_content_label}>
