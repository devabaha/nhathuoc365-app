...
const GUIDE_MESSAGE =
  'Trong tháng, ví Tiền mặt trên Web được rút về TK Tạm ứng trên App, chỉ được sử dụng trong chuỗi Macca Coffee+, không được rút ra tiền mặt. Lệnh rút được thực hiện ngay lập tức.';
        ...
        try {
          var response = await APIHandler[
            typeWallet === '0'
              ...
              : 'investor_send_advance_withdraw'
          ](data);
      ...
      <Fragment>
        ...
        >
          ...
          <View style={{ marginHorizontal: 15 }}>
            <Text style={{ color: '#404040', fontSize: 18 }}>Số tiền</Text>
            <TextInput
            ...
            />
            {this.state.isError && (
              <Text style={{ color: 'red', fontSize: 16 }}>{ERROR_MONEY}</Text>
            )}
          </View>
          <TouchableHighlight
          ...
          >
            <View style={styles.empty_box_btn}>
              <Text style={styles.empty_box_btn_title}>Rút về App</Text>
            </View>
          </TouchableHighlight>
          <View style={[styles.note_container]}>
            <Text style={[styles.note]}>{GUIDE_MESSAGE}</Text>
          </View>
        </ScrollView>
      </Fragment>
    );
