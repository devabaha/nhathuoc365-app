                        ...
                        <TouchableHighlight underlayColor="#ffffff">
                            <View style={{flexDirection: 'row', alignItems: "center", marginBottom: 10,}}>
                                <Icon
                                    ...
                                    color="#999999"
                                />
                                <Text style={styles.input_label_header}>Chi tiết giao dịch</Text>
                            </View>
                        </TouchableHighlight>
                        <View style={styles.block_detail_content}>
                            <View>
                                ...
                                <View style={styles.block_continue_content_label_no_border}>
                                    ...
                                    <View style={styles.block_continue_content_label_right}>
                                        <Text style={[styles.blocl_continue_input_label, {color: DEFAULT_COLOR}]}>{this.props.detail.price_select}</Text>
                                    </View>
                                </View>
                                <View style={styles.block_continue_content_label}>
                                    <Text style={styles.blocl_continue_input_label}>Hoàn tiền</Text>
                                    <View style={styles.block_continue_content_label_right}>
                                        <Text style={[styles.blocl_continue_input_label, {color: DEFAULT_COLOR}]}>{this.props.detail.discount_label}</Text>
                                    </View>
                                </View>
                                <View style={styles.block_continue_content_label}>
                                    <Text style={styles.blocl_continue_input_label}>Phí giao dịch</Text>
                                    <View style={styles.block_continue_content_label_right}>
                                        <Text style={[styles.blocl_continue_input_label, {color: DEFAULT_COLOR}]}>Miễn
                                            phí</Text>
                                    </View>
                                </View>
                                <View style={styles.block_continue_content_label_no_border}>
                                    ...
                                    <View style={styles.block_continue_content_label_right}>
                                        <Text style={[styles.blocl_continue_input_label, {color: DEFAULT_COLOR}]}>{this.props.detail.pay}</Text>
                                    </View>
                                </View>
                                <View style={styles.block_continue_content_label_no_border}>
                                    <Text style={styles.blocl_continue_input_label}>Ví TickID</Text>
                                    <View style={styles.block_continue_content_label_right}>
                                        <Text style={[styles.blocl_continue_input_label, {color: DEFAULT_COLOR}]}>50.000
                                            đ</Text>
                                    </View>
                                </View>
                                <View style={styles.block_continue_content_label}>
                                    <Text style={styles.block_continue_input_label}>Ví tạm ứng</Text>
                                    <View style={styles.block_continue_content_label_right}>
                                        <Text style={[styles.block_continue_input_label, {color: DEFAULT_COLOR}]}>46.000
                                            đ</Text>
                                    </View>
                                </View>
                                <View style={styles.block_continue_content_label_no_border}>
                                    <Text style={styles.block_continue_input_label}>Tiền mặt </Text>
                                    <View style={styles.block_continue_content_label_right}>
                                        <Text style={[styles.block_continue_input_label, {color: DEFAULT_COLOR}]}>0
                                            đ</Text>
                                    </View>
                                </View>
                            </View>
                ...
                <View style={[styles.boxButtonActions, {
                    ...
                    <TouchableHighlight
                        ...
                        <View style={[styles.boxButtonAction, {
                            ...
                            <Icon style={styles.starReviews} name="check" size={12} color="#ffffff"/>
