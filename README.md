...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "update UI, logic request"
code-push release-react tick-homeid-android android -d "Production" -m --description "update UI, logic request"
