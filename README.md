...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "fix list service"
code-push release-react tick-homeid-android android -d "Production" -m --description "fix list service"
