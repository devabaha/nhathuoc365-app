...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "change little things"
code-push release-react tick-homeid-android android -d "Production" -m --description "change little things"
