...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "fix bugs image messages in comments"
code-push release-react tick-homeid-android android -d "Production" -m --description "fix bugs image messages in comments"
