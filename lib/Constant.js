...
global.HOTLINE = '0981830981';

// codepush deployment keys (staging)
global.CPDK = {
  'ios': 'gwgM08BjYlLGc0Pyq80SWYkjjlMLddb65740-40fb-4eaf-bca7-d3affa881ccb',
  'android': 'ecugVsoMl__AenjCI51dSmGt7juSddb65740-40fb-4eaf-bca7-d3affa881ccb'
};
...
// Apps
global.APP_NAME = 'MACCACA'; //Ma cua ung dung, khong thay doi, vi dung ten nay gan vao device id
global.APP_NAME_SHOW = 'MACCACA';
global.TIME_THE_LAUNCH = 1000;
global.DELAY_UPDATE_NOTICE = 5000;

global.GA_ID = 'UA-141706963-2';

// color
global.DEFAULT_COLOR = '#2c6ca3';//2c6ca3
...
global.EMAIL_SUPPORT = 'info@maccaca.vn';
global.APP_FANPAGE = 'http://maccaca-fanpage.tickid.vn';
global.APP_INFO = 'http://maccaca-info.tickid.vn';
