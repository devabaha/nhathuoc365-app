...
const History = (props) => {
    ...
    return (
        ...
        // }
        >   
            {historyData.length?historyRender:(<Text>Tài khoản chưa có giao dịch</Text>)}
        </ScrollView>
    )
}
        ...
        <View style={[styles.history_row]}>
            ...
            <Fragment>
                <View style={[styles.history_row_last_content]}>
                    <Text style={[
                        styles.des,
                        { fontWeight: 'bold', fontSize: 16, position: "absolute", top: -6, right: 0, }
                    ]}>
                        {props.money}
                    </Text>
                    <Text style={[
                        styles.des,
                        { color: "#cc9900",fontSize: 12, position: "absolute", top: 10, right: 0, }
                    ]}>
