...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "fix chat user_id, complete epay flow"
code-push release-react tick-homeid-android android -d "Production" -m --description "fix chat user_id, complete epay flow"
