...
import ADMIN_APIHandler from '../network/ADMIN_APIHandler';
global.ADMIN_APIHandler = ADMIN_APIHandler;
...
global.url_for = (url) => {
  ...
  var secret_key = '0406mydinhhubjfsdfd1414h52';
  var device_id = DeviceInfo.getUniqueID();
  var app_key = 'mydinhhubkey';
  var os = Platform.OS;
