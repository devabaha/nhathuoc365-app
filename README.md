...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "update bills"
code-push release-react tick-homeid-android android -d "Production" -m --description "update bills"
