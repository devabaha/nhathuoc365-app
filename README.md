...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "add module customer and order management beeland"
code-push release-react tick-homeid-android android -d "Production" -m --description "add module customer and order management beeland"
