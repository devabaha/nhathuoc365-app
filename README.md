...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "add room list"
code-push release-react tick-homeid-android android -d "Production" -m --description "add room list"
