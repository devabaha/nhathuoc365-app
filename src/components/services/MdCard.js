...
class MdCard extends Component {
  ...
  async _getData(delay) {
    try {
      var response = await APIHandler.service_detail(
        'md_card',
        this.props.store.store_id
      );
          ...
          >
            <View style={styles.block_continue_content_label}>
              ...
              <View style={styles.block_continue_content_label_right}>
                ...
                >
                  {this.state.telco} {this.state.price_select}
                </Text>
              </View>
            </View>
            <View style={styles.block_continue_content_label}>
...
export default observer(MdCard);