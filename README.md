...
code-push release-react tick-homeid-ios ios -d "Production" -m --description "fix UI"
code-push release-react tick-homeid-android android -d "Production" -m --description "fix UI"
