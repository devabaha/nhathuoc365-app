...
code-push release-react tick-tickid-ios ios -d "Production" -m --description "Upgrade login firebase"
code-push release-react tick-tickid-android android -d "Production" -m --description "Upgrade login firebase"
