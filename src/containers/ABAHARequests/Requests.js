...
class Requests extends Component {
  ...
  siteRequestsRequest = new APIRequest();
  requests = [this.siteRequestsRequest];
  ...
  getRequests = async () => {
    const {t} = this.props;
    this.siteRequestsRequest.data = ADMIN_APIHandler.site_requests_site(
      this.props.siteId,
    );
    try {
      const response = await this.siteRequestsRequest.promise();
  ...
  handlePressRequest(request) {
    Actions.push(appConfig.routes.abahaRequestDetail, {
      siteId: this.props.siteId,
